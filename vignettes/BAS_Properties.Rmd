...
output: pdf_document
---
This vigette demonstrates basic Balanced Acceptance Sampling (BAS) of a point resource.
BAS will sample a simple point resouce consisting of a 10 X 10 grid of points evenly spaced on a square study area with width 100. The following code creates the example population.  
