...
context("Test the voronoi.polygons function")


test_that("voronoi.polygons() operates appropriately", {
  
  # check if the function stops with message
  expect_error(obj <- voronoi.polygons(1, 1), "Must pass a SpatialPoints* object to voronoi.polygons.",  fixed=TRUE)
